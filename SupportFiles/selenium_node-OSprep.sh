...
then
   ...
   logit "Adding selenium-node exception to running firewalld config... "
   firewall-cmd --add-service=selenium-node || \
     err_exit "Failed adding selenium-node to running firewalld config"
   logit "Adding selenium-node exception to persistent firewalld config... "
   firewall-cmd --add-service=selenium-node --permanent || \
     err_exit "Failed adding selenium-node to permanent firewalld config"
...
then
   ...
   logit "Adding selenium-node exception to persistent firewalld config... "
   firewall-offline-cmd --add-service=selenium-node
     err_exit "Failed adding selenium-node to firewalld config"
